...
MidiEventType = Literal[
    ...
    "Sustain", "ModWheel", "AllNotesOff", "ResetControllers",
]
...
class MidiEvent(pydantic.BaseModel):
    ...
    chord: Chord | None = pydantic.Field(default=None, description="Underlying chord in the progression (does not necessarily match the current note)")
